...
import ca.uwinnipeg.proximitydroid.v2.fragments.AboutDialogFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.AddRegionFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.ComplimentFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.DifferenceFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.FeatureFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.ImageFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.IntersectionFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.NeighbourhoodFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.PropertyFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.RegionFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.UpperApproxFragment;
import ca.uwinnipeg.proximitydroid.v2.fragments.AddRegionFragment.ListNavigationProvider;
import ca.uwinnipeg.proximitydroid.v2.fragments.AddRegionFragment.OnClosedListener;
import ca.uwinnipeg.proximitydroid.v2.fragments.RegionFragment.OnAddRegionSelectedListener;
...
public class ProximityDroidActivity 
  ...
  public static final String UPPER_APPROX_TAG = "upperapprox";
  ...
  public class TabListener implements ActionBar.TabListener {
    ...
    public void onTabSelected(Tab tab, FragmentTransaction ft) {
      ...
      if (mFragment == null) {
        ...
        // connect the service if we can
        if (isBound()) {
          mFragment.bindService(getService());
         }
